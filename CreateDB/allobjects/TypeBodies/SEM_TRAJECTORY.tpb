...
CREATE OR REPLACE type body               SEM_TRAJECTORY is
  ...
  */
  ...
  begin
    select value(e)
      ...
      order by e.mbb.minpoint.t.m_y,e.mbb.minpoint.t.m_m,e.mbb.minpoint.t.m_d,e.mbb.minpoint.t.m_h,e.mbb.minpoint.t.m_min,e.mbb.minpoint.t.m_sec;
  ...
  */
  ...
  intag varchar2(50);
  begin
    outsemtraj:=sem_trajectory(self.sem_trajectory_tag,self.srid,sem_episode_tab(),self.o_id,self.semtraj_id, self.profile_id);
