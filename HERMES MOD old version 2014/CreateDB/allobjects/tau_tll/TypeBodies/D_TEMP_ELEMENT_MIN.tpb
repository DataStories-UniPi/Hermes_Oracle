Prompt drop Type Body D_TEMP_ELEMENT_MIN;
DROP TYPE BODY D_TEMP_ELEMENT_MIN
/

Prompt Type Body D_TEMP_ELEMENT_MIN;
CREATE OR REPLACE type body D_Temp_Element_Min is
