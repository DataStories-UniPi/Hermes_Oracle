...
CREATE OR REPLACE package Statistics is
  ...
  procedure createviewsubs2mpoints(sourcetable varchar2);
  procedure dropviewsubs2mpoints(sourcetable varchar2);
  ...
  procedure dropdatasetstats(sourcetable varchar2);
